...
;; NalaGinrut added irregex-match-prefix and irregex-match-suffix

(define-module (tekuti irregex)
  #:export (irregex-match irregex-search irregex string->irregex sre->irregex
            ...
            irregex-fold irregex-match-prefix irregex-match-suffix))
...
(define (irregex-match-prefix m)
  (let ((i (irregex-match-start-index m)) 
        (str (car (irregex-match-start-chunk m))))
    (substring str 0 i)))

(define (irregex-match-suffix m)
  (let ((i (irregex-match-end-index m))
        (str (car (irregex-match-start-chunk m))))
    (substring str i)))
